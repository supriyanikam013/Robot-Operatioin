...
namespace Robot_Operatioin.BusinessLogic
{
    ...
    //            lastErrorString = "Die Variable '" + variable + "' could not be decrypted!";
    //            return lastErrorCode;
    //        }
    //    }
    //    #endregion
    ...
    //    {
    //        double numBytes = MySql.Data.Types.Struct.GetStructSize(structType);
    ...
    //            Types.ByteArray package = new MySql.Data.Types.ByteArray(packageSize);

    //            package.Add(new byte[] { 3, 0, 0 });
    //            package.Add((byte)packageSize);
    //            package.Add(new byte[] { 2, 0xf0, 0x80, 0x32, 1, 0, 0 });
    //            package.Add(MySql.Data.Types.Word.ToByteArray((ushort)(varCount - 1)));
